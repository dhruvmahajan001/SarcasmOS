...
- 😏 Sarcastic and funny interface theme
- 💻 Futuristic OS-inspired design
...
SarcasmOS was built as a fun frontend project to experiment with:
- Creative web design
- Interactive UI/UX
- Smooth animations
- Humor-based web experiences

The goal of the project is to provide an entertaining and visually engaging browser experience.
